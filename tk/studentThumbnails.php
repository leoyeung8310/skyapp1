...
try {
    ...
    //prepare query
	$stmt = $db->prepare ("select teacherNotes.NoteID as teacherNoteID, QuestionTable.QuestionID, QuestionTable.Subject, QuestionTable.QuestionType, QuestionTable.Topic, QuestionTable.SubTopic, GroupTable.GroupID, GroupTable.GroupName, UserTable.UserID, UserTable.UserName, AnswerTable.AnswerID, AnswerTable.Marks, AnswerTable.CountCorrect, AnswerTable.CountIncorrect, AnswerTable.CountHappy, AnswerTable.CountNoIdea, AnswerTable.CountTimesUp, AnswerTable.teacherCorrect, AnswerTable.teacherIncorrect, AnswerTable.NoOfTrial, AnswerTable.TimeTaken, studentNotes.NoteID as studentNoteID, studentNotes.Thumbnail, GroupRelationshipTable.ClassNo as ClassNo 
	...
	order by teacherNoteID, QuestionTable.QuestionID, GroupTable.GroupID, ClassNo, UserTable.UserID, AnswerTable.AnswerID, studentNoteID");
